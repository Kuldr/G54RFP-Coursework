...
\lstinputlisting[language=Haskell, firstline=29, lastline=36]{reportCode.hs}
\par
...
\lstinputlisting[language=Haskell, firstline=38, lastline=42]{reportCode.hs}
\par
...
\lstinputlisting[language=Haskell, firstline=44, lastline=45]{reportCode.hs}
\par
